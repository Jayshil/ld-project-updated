...
for i in range(len(teff)):
	table1.write(name[i] + ' & $' + str(np.format_float_positional(u1[i], 3)) + '^{+' + str(np.format_float_positional(u1p[i], 3)) + '}_{-' + str(np.format_float_positional(u1n[i], 3)) + '}$ & $' + str(np.format_float_positional(u2[i], 3)) + '^{+' + str(np.format_float_positional(u2p[i], 3)) + '}_{-' + str(np.format_float_positional(u2n[i], 3)) + '}$ & ' + str(np.format_float_positional(u1_code_ata[i], 3)) + ' & ' + str(np.format_float_positional(u2_code_ata[i], 3)) + ' & ' + str(np.format_float_positional(u1_code_pho[i], 3)) + ' & ' + str(np.format_float_positional(u2_code_pho[i], 3)) + ' & ' + str(np.format_float_positional(u1_cla_ata[i], 3)) + ' & ' + str(np.format_float_positional(u2_cla_ata[i], 3)) + ' & ' + str(np.format_float_positional(u1_cla_pho[i], 3)) + ' & ' + str(np.format_float_positional(u2_cla_pho[i], 3)) + ' & ' + str(np.format_float_positional(u1_cla_pho_r[i], 3)) + ' & ' + str(np.format_float_positional(u2_cla_pho_r[i], 3)) + ' \\\\ \n\t')
	table2.write(name[i] + ' & ' + str(teff[i]) + ' & ' + str(lg[i]) + ' & ' + str(mh[i]) + ' & ... \\\\ \n\t')
	table3.write(name[i] + 'b & $' + str(np.format_float_positional(re[i], 3)) + '^{+' + str(np.format_float_positional(reep[i], 3)) + '}_{-' + str(np.format_float_positional(reen[i], 3)) + '}$ & $' + str(np.format_float_positional(ae[i], 3)) + '^{+' + str(np.format_float_positional(aeep[i], 3)) + '}_{-' + str(np.format_float_positional(aeen[i], 3)) + '}$ & $' + str(np.format_float_positional(tce[i] - 2458000, 5)) + '^{+' + str(np.format_float_positional(tcep[i], 5)) + '}_{-' + str(np.format_float_positional(tcen[i], 5)) + '}$ & $' + str(np.format_float_positional(rprst[i], 3)) + '^{+' + str(np.format_float_positional(rprstperr[i], 3)) + '}_{-' + str(np.format_float_positional(rprstnerr[i], 3)) + '}$ & $' + str(np.format_float_positional(aste[i], 3)) + '^{+' + str(np.format_float_positional(asteperr[i], 3)) + '}_{-' + str(np.format_float_positional(astenerr[i], 3)) + '}$ & $' + str(np.format_float_positional(xx1[i] - 2458000, 3)) + ' \pm ' + str(np.format_float_positional(xx11[i], 3)) + '$ \\\\ \n\t')
