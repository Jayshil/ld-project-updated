...
ax_u1_c_pr.errorbar(u1_j, u1_c_pr, xerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.5,\
	 color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
ax_u1_c_pr.errorbar(u1_j, u1_c_ar, xerr = [u1_jn, u1_jp], fmt='.', elinewidth=1, alpha=0.5,\
	 color='darkred',zorder=5, label = 'PHOENIX LDCs - r method')
...
ax_u2_c_pr.errorbar(u2_j, u2_c_pr, xerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.5,\
	 color='deepskyblue', zorder=5, label = 'PHOENIX LDCs - q method')
ax_u2_c_pr.errorbar(u2_j, u2_c_ar, xerr = [u2_jn, u2_jp], fmt='.', elinewidth=1, alpha=0.5,\
	 color='darkred',zorder=5, label = 'PHOENIX LDCs - r method')
...
plt.errorbar(bin_teff, bin_diff_u1_c_p, xerr=bin_teffe, yerr=bin_diff_u1_c_pe, fmt='o',\
...
plt.errorbar(bin_teff, bin_diff_u1_c_a, xerr=bin_teffe, yerr=bin_diff_u1_c_ae, fmt='o',\
...
plt.errorbar(bin_teff, bin_diff_u2_c_p, xerr=bin_teffe, yerr=bin_diff_u2_c_pe, fmt='o',\
	 color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u2_c_a, bin_diff_u2_c_ae = utl.binned_data(datax=teff, datay=diff_u2_c_a, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_c_a, xerr=bin_teffe, yerr=bin_diff_u2_c_ae, fmt='o',\
	 color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
plt.errorbar(bin_teff, bin_diff_u1_co_p, xerr=bin_teffe, yerr=bin_diff_u1_co_pe, fmt='o',\
	 color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u1_co_a, bin_diff_u1_co_ae = utl.binned_data(datax=teff, datay=diff_u1_co_a, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_co_a, xerr=bin_teffe, yerr=bin_diff_u1_co_ae, fmt='o',\
	 color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
plt.errorbar(bin_teff, bin_diff_u2_co_p, xerr=bin_teffe, yerr=bin_diff_u2_co_pe, fmt='o',\
	 color='orangered', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='orangered', zorder=10)

bin_teff, bin_teffe, bin_diff_u2_co_a, bin_diff_u2_co_ae = utl.binned_data(datax=teff, datay=diff_u2_co_a, datay_err=u2_jp)
plt.errorbar(bin_teff, bin_diff_u2_co_a, xerr=bin_teffe, yerr=bin_diff_u2_co_ae, fmt='o',\
	 color='cornflowerblue', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='cornflowerblue', zorder=10)
...
bin_teff, bin_teffe, bin_diff_u1_c_p, bin_diff_u1_c_pe = utl.binned_data(datax=teff, datay=diff_u1_c_p, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_p, xerr=bin_teffe, yerr=bin_diff_u1_c_pe, fmt='o',\
	 color='deepskyblue', mew=2, ms=8, alpha=1, markerfacecolor='white', mec='deepskyblue', zorder=10)

bin_teff, bin_teffe, bin_diff_u1_c_ar, bin_diff_u1_c_aer = utl.binned_data(datax=teff, datay=diff_u1_c_ar, datay_err=u1_jp)
plt.errorbar(bin_teff, bin_diff_u1_c_ar, xerr=bin_teffe, yerr=bin_diff_u1_c_aer, fmt='o',\
	 color='darkred', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='darkred', zorder=10)
...
plt.errorbar(bin_teff, bin_diff_u2_c_ar, xerr=bin_teffe, yerr=bin_diff_u2_c_aer, fmt='o',\
	 color='darkred', mew=2, alpha=1, ms=8, markerfacecolor='white', mec='darkred', zorder=10)
